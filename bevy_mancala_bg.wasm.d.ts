...
export function wasm_bindgen__convert__closures__invoke0_mut__h7321e99dbc7b82d4(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h50a619d62a52d9bd(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h751034c78217e47d(a: number, b: number, c: number, d: number): void;
